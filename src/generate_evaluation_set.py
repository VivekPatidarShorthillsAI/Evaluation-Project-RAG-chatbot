...
# Initialize logging
LOG_FILE = Path('assets/evaluation.log')
...
class EvaluationGenerator:
    ...
    def load_queries(self, filepath: Path) -> list:
        """Load just the queries from golden_set.json"""
        try:
...
async def main():
    try:
        ...
        golden_set_path = assets_dir / 'golden_set.json'
        output_path = assets_dir / 'model_output.json'
